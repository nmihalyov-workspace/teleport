            ...
            <div className="footer__bottom">
              ...
              <div className="footer__col">
                <div className="footer-list">
                  <div className="footer-list__title">Продукты</div><Link className="footer-list__link" href="#">Банковская гарантия</Link><Link className="footer-list__link" href="#">Кредит на исполнение контракта</Link><Link className="footer-list__link" href="#">Тендерные займы</Link><Link className="footer-list__link" href="#">Открытие р/с</Link><Link className="footer-list__link" href="#">Выпуск ЭЦП</Link>
                </div>
              </div>
              <div className="footer__col">
                <div className="footer-list">
                  <div className="footer-list__title">Документация</div><Link className="footer-list__link" href="#">Инструкции</Link><Link className="footer-list__link" href="#">Полезные ссылки</Link>
                </div>
              </div>
              <div className="footer__col">
                <div className="footer__hash">#ВремяДеньги</div>
                <div className="footer__socials footer-socials"><Link className="footer-socials__item" href="#"><svg className="footer-socials__icon svg">
                      <use xlinkHref="/img/svgSprite.svg#icon__vk"></use>
                    </svg></Link><Link className="footer-socials__item" href="#"><svg className="footer-socials__icon svg">
                      <use xlinkHref="/img/svgSprite.svg#icon__fb"></use>
                    </svg></Link><Link className="footer-socials__item" href="#"><svg className="footer-socials__icon svg">
                      <use xlinkHref="/img/svgSprite.svg#icon__tg"></use>
                    </svg></Link></div><Link className="footer__button" href="#">Свяжитесь со мной</Link>
              </div>
            </div>
          </div>
        </div>
