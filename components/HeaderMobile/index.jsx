...
const HeaderMobile = () => {
	return (
      ...
      <Link href="/">
				<Image src="/assets/media/logos/logo_white.svg" width="154" height="30" alt="Logo" className="h-30px"/>
      </Link>
			<div className="d-flex align-items-center">
				<button id="kt_aside_mobile_toggle" className="btn p-0 burger-icon burger-icon-left">
					<span></span>
        </button>
				<button id="kt_header_mobile_toggle" className="btn p-0 burger-icon ml-5">
					<span></span>
        </button>
