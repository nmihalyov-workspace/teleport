            ...
            <div className="header__bottom">
              <div className="header__nav-scroll">
                <div className="header__nav header-nav">
                  <div className="header-nav__item"><Link className="header-nav__text" to="/#about">О нас</Link></div>
                  <div className="header-nav__item"><Link className="header-nav__text" to="/#production">Продукты</Link><a href="javascript:void(0)" className="header-nav__trigger"><svg className="header-nav__icon svg">
                  ...
                  <div className="header-nav__item"><Link className="header-nav__text" to="/#agent">Агентам</Link></div>
                  <div className="header-nav__item"><Link className="header-nav__text" to="/#partners">Партнёры</Link></div>
                  <div className="header-nav__item"><Link className="header-nav__text" to="/calculator">Калькулятор</Link></div>
                </div>
              </div>
            </div>
          </div>
