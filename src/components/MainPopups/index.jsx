  ...
  return (<>
    <Hystmodal
      ...
      <div className="modal-form">
        <div className="modal-form__tiles"><Link className="modal-form__tile hystmodal__remove" to="/signup/agent"><svg className="modal-form__tile-icon svg">
              <use xlinkHref="/img/svgSprite.svg#icon__agent"></use>
            </svg>
            <div className="modal-form__tile-title">Агент</div>
          </Link><Link className="modal-form__tile hystmodal__remove" to="/signup"><svg className="modal-form__tile-icon svg">
              <use xlinkHref="/img/svgSprite.svg#icon__client"></use>
            </svg>
            <div className="modal-form__tile-title">Клиент</div>
          </Link></div>
    ...
    <Hystmodal
      ...
      footer={<div className="popup__footer popup__footer_modal"><Link className="button button_blue" to="/calculator">Рассчитать стоимость</Link><a className="button" data-hystmodal="#request">Оставить заявку</a></div>}>
    ...
    <Hystmodal
      ...
      footer={<div className="popup__footer popup__footer_modal"><Link to="/" className="button">ОК</Link></div>}>
      <div className="production-popup">
        <div className="production-popup__row">
          <div className="production-popup__col">
