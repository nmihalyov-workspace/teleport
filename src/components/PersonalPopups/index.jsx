  ...
  return (<>
    ...
    <Modal
      ...
      footer={<><button className="btn btn-light-primary font-weight-bold" type="button" data-dismiss="modal">Закрыть</button></>}><>
        <div className="rounded bg-light p-3 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-abb.png"/><span className="label label-warning label-pill label-inline mr-2 my-2">Запрос от банка</span></div>
        <div className="rounded bg-light p-3 mt-2 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-gp.png"/><span className="label label-danger label-pill label-inline mr-2 my-2">Отклонена банком</span></div>
        <div className="rounded bg-light p-3 mt-2 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-rs.png"/><span className="label label-light-success label-pill label-inline mr-2 my-2">Есть предложение</span></div>
        <div className="rounded bg-light p-3 mt-2 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-spb.png"/><span className="label label-info label-pill label-inline mr-2 my-2">Доступна банку</span></div>
        <div className="rounded bg-light p-3 mt-2 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-us.png"/><span className="label label-secondary label-pill label-inline mr-2 my-2">Доступна отправка</span></div>
        <div className="rounded bg-light p-3 mt-2 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-us.png"/><span className="label label-success label-pill label-inline mr-2 my-2">Исполнена</span></div>
        <div className="rounded bg-light p-3 mt-2 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-abb.png"/><span className="label label-warning label-pill label-inline mr-2 my-2">Принято другое предложение</span></div>
        <div className="rounded bg-light p-3 mt-2 d-flex align-items-center justify-content-between flex-wrap"><img className="w-auto h-25px" alt="bank" src="assets/media/logos/bank-abb.png"/><span className="label label-danger label-pill label-inline mr-2 my-2">Изменение комиссии</span></div>
    </></Modal>
  </>);
};
