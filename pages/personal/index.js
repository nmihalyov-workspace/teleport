...
import dataIsReady from '../../helpers/dataIsReady.js';
...
const ProfilePage = ({ user }) => {
  ...
  return (
    <AppWrapper title="Профиль" personal>
      {dataIsReady(user) &&
                  ...
                  <div className="card-body">
                    <div className="d-flex">
                      <div className="d-flex flex-column">
                        ...
                        <div className="d-flex flex-column mb-2"><span className="text-dark font-size-h5 font-weight-bold mb-0">{user.agent_organization.head_position}</span><span className="text-muted font-weight-bold">ИНН: {user.agent_organization.inn}</span></div>
                      ...
                      <div className="card-body pt-6">
                        <div className="row mb-5">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.head_full_name}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.head_position}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9"><a className="btn btn-primary btn-sm btn-light-primary font-weight-bold" href={user.agent_organization.director_passport} download>Скачать</a></div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                            <div className="text-muted text-right">Протокол/решение о назначении</div>
                          </div>
                          <div className="col-12 col-sm-8 col-md-9"><a className="btn btn-primary btn-sm btn-light-primary font-weight-bold" href={user.agent_organization.director_appointment_protocol} download>Скачать</a></div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                    ...
                    <div className="tab-pane fade" id="profile_tab_2" role="tabpanel" aria-labelledby="profile_tab_2">
                      <div className="card-body pt-6">
                        ...
                        <div className="row mb-5">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            {taxations.map(el => {
                              if (el.id === user.agent_organization.taxation_system_id) {
                        ...
                        <div className="row mb-5">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.ogrn}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.inn}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.kpp}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.okved}</div>
                        ...
                        <div className="row mb-5">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{Intl.DateTimeFormat('ru-Ru', {day: 'numeric', month: 'long', year: 'numeric'}).format(new Date(user.agent_organization.registration_date))}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.employees_number}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.authorized_capital} ₽</div>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9"><a className="btn btn-primary btn-sm btn-light-primary font-weight-bold" href={user.agent_organization.charter} download>Скачать</a></div>
                        </div>
                      </div>
                    ...
                    <div className="tab-pane fade" id="profile_tab_3" role="tabpanel" aria-labelledby="profile_tab_3">
                      <div className="card-body pt-6">
                        ...
                        <div className="row mb-5">
                          ...
                          <div className="col-12 col-sm-8 col-md-9"><a className="text-primary font-weight-bold" href={`mailto:user.email`}>{user.agent_organization.email}</a></div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.address_legal}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                            <div className="text-muted text-right">Фактический адрес</div>
                            <div className="text-success text-right font-size-sm">{user.agent_organization.address_actual_matches_legal === 1 ? 'совпадает с юридическим адресом' : 'не совпадает с юридическим адресом'}</div>
                          </div>
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.address_actual}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                            <div className="text-muted text-right">Почтовый адрес</div>
                            <div className="text-success text-right font-size-sm">{user.agent_organization.address_post_matches_legal === 1 ? 'совпадает с юридическим адресом' : 'не совпадает с юридическим адресом'}</div>
                          </div>
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.address_post}</div>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-12 col-sm-4 col-md-3">
                    ...
                    <div className="tab-pane fade" id="profile_tab_4" role="tabpanel" aria-labelledby="profile_tab_4">
                      <div className="card-body pt-6">
                        <div className="row mb-5">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.bank_bik}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.bank_name}</div>
                          </div>
                        </div>
                        <div className="row mb-5">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.bank_ks}</div>
                          </div>
                        </div>
                        <div className="row">
                          <div className="col-12 col-sm-4 col-md-3">
                          ...
                          <div className="col-12 col-sm-8 col-md-9">
                            <div className="text-dark-75 font-weight-bold">{user.agent_organization.bank_rs}</div>
                          </div>
                        </div>
                      </div>
...
export default withUserData(ProfilePage);